...
// Harbor projects + robot accounts are provisioned and persisted by the
// project-controller (in a per-namespace Secret in its own namespace), so the
// web app no longer tracks registry credentials in the database.
