<script lang="ts">
  ...
  import { getProjectMetrics, getProjectMetricsRange } from '$lib/remote/metrics.remote'
  ...
  function fetchRange(window: TimeWindow, _groupBy: GroupBy) {
    return getProjectMetricsRange({ window })
  }
</script>
